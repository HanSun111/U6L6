...
public class Main
{
    public static void main(String[] args)
    {
        ...
        ArrayAlgorithms.shiftNumLeftModifyTwo(nums, 2);

        // original array IS modified; all elements shifted left 2
        System.out.println(Arrays.toString(nums));

        int[] sameNums = {1, 2, 3, 4, 5, 6};
        ArrayAlgorithms.shiftNumLeftModifyTwo(sameNums, 4);
        ...
        ArrayAlgorithms.shiftNumLeftModifyTwo(moreNums, 8);
        ...
        ArrayAlgorithms.shiftNumLeftModifyTwo(moreNumsAgain, 10);
